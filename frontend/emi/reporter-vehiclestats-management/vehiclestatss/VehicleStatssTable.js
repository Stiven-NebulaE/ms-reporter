                        ...
                        <CardContent>
                            ...
                            <Box mb={2}>
                                <Box display="flex" alignItems="center" gap={1}>
                                    ...
                                    <Chip label={hpStats.min !== null && hpStats.min !== undefined ? hpStats.min : 'N/A'} size="small" />
                                </Box>
                            </Box>
                            <Box mb={2}>
                                <Box display="flex" alignItems="center" gap={1}>
                                    <Typography variant="body2">Máximo:</Typography>
                                    <Chip label={hpStats.max !== null && hpStats.max !== undefined ? hpStats.max : 'N/A'} size="small" />
                                </Box>
                            </Box>
                            <Box mb={2}>
                                <Box display="flex" alignItems="center" gap={1}>
                                    <Typography variant="body2">Promedio:</Typography>
                                    <Chip label={hpStats.avg !== null && hpStats.avg !== undefined ? hpStats.avg.toFixed(1) : 'N/A'} size="small" />
                                </Box>
                            </Box>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <Grid container spacing={2}>
                                {Object.entries(vehiclesBySpeedClass)
                                    .filter(([key]) => key !== '__typename')
                                    .map(([speedClass, count]) => (
